...
public class ReportData {
    ...
    static int index=0;// Tracks the total number of ReportData objects created
    ...
    // Constructor used to initialize a new product record
    ...
    // Getter methods used to retrieve product details
    ...
    // Setter methods used to update product details
    ...
    public void setWarranty(int warr){
        this.warranty=warr;
    }
